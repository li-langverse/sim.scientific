...
| **Base sim API** | [li-langverse/sim](https://github.com/li-langverse/sim) — `SimRunResult`, vertical/algo ids |
| **Vision / RFC** | [world-studio-vision § PH-SCI](https://github.com/li-langverse/lic/blob/main/docs/game-dev/world-studio-vision.md) (monorepo copy) |
...
```bash
# Build lic first: https://github.com/li-langverse/lic — then:
